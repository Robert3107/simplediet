...
public class RecipeDetails {
    ...
    public RecipeDetails(int id, String title, String image, String imageType, int servings, int readyInMinutes,
                         String license, String sourceName, String sourceUrl, String spoonacularSourceUrl,
                         int aggregateLikes, double healthScore, double spoonacularScore, double pricePerServing,
                         List<AnalyzedInstructions> analyzedInstructions, boolean cheap, String creditsText, List<Object> cuisines,
                         boolean dairyFree, List<Object> diets, String gaps, boolean glutenFree, String instructions,
                         boolean ketogenic, boolean lowFodmap, List<Object> occasions, boolean sustainable,
                         boolean vegan, boolean vegetarian, boolean veryHealthy, boolean veryPopular, boolean whole30,
                         int weightWatcherSmartPoints, List<String> dishTypes, List<RecipeIngredients> extendedIngredients,
                         String summary, WinePairing winePairing, String originalId) {
        this.id = id;
        this.title = title;
        this.image = image;
